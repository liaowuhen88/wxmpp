...
public class RobotConstant {
    ...
    public static final String HAS_REGIST_TIP = "欢迎进入豆包自助报案服务，请上传以下图片，全部上传完请输入'Y'结束(1)出险人身份证正反面(2)银行卡正方面(3)医疗费用原始收据(4)医疗费用明细清单(5)门急诊病历或住院小结(6)处方。注意：请在30分钟内完成整个操作，否则需要重新申请，也可回复'关闭'，终止此次自助服务。";
